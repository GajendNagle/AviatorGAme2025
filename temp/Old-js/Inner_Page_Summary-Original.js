        ...
        function (OrjsonDS) {
            if (OrjsonDS.length == 0) {
                ...
                for (var i = 0; i < OrjsonDS.length; i++) {
                    ...
                    //$('#prof_pic').html(OrjsonDS[i].Mem_Profl_Pic);
                    ...
                    /*----invite.html(whatsapp share)-----*/
                    
                    $("#sharewt").val(OrjsonDS[i].CompName + " - The most amazing part of becoming our agent is that if the quality of your invited downlines is high, you have the opportunity to offer them free bonuses. " + '' +" https://redrakegame.com/ref/" + OrjsonDS[i].MemID);

                    /*----parity.html(deduction)-----*/
                    ...
                    //$('#MsgCunt').html(OrjsonDS[i].Msg_Cunt);
                    //$('#MsgCunt2').html(OrjsonDS[i].Msg_Cunt);
                    //////////////
                    $('#MsgCunt').html(OrjsonDS[i].Tot_Msg_Cunt);
                    $('#MsgCunt2').html(OrjsonDS[i].Tot_Msg_Cunt);
              
                    $('#Tot_Msg_Cunt').html(OrjsonDS[i].Tot_Msg_Cunt);
                    ////deposit by paymentgateway page Payment Options value
                ...
                /*    $('#txncharge1').val(OrjsonDS[i].PGTxnCharge);*/
                    ...
                    //$("#totfund").html("$" + OrjsonDS[i].TotFnd),// totalfund
                    ...
                    $('#Icr').html("$"+OrjsonDS[i].Icr);//Level Bonus
                    $('#Idr').html(OrjsonDS[i].Idr);

                    $('#SiIcr').html("$" + OrjsonDS[i].Income5);//Global Pool Bonus
                    $('#TbiIcr').html("$" + OrjsonDS[i].TbiIcr);//Award Bonus

                    $('#Totcnffr').html(OrjsonDS[i].Totcnffr);
                    $('#Totfr').html(OrjsonDS[i].Totfr);

                    $('#DBal').html(OrjsonDS[i].TmPsBal); ///DBal

                    $('#Dcr').html("$"+OrjsonDS[i].Dcrinc); ///Dcr -->bot refferal income
                    $('#Ddr').html(OrjsonDS[i].TmPsOut); ///Ddr
                    ...
                    $('#PRcr').html("$"+OrjsonDS[i].Rcr);//Referral Bonus
                    ...
                    $('#SRin').html("$" + OrjsonDS[i].Income2);///Two Fold Bonus
                    $('#SRout').html(OrjsonDS[i].Srdr);
                    //$('#TmPsBal').html("$" + OrjsonDS[i].TmPsBal);
                    ...
                    /*-----With Page-----*/
                    $('#Deductioncharge').html(OrjsonDS[i].DedWith + " TRX");
