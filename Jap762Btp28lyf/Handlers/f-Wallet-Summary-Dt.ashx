<%@ WebHandler Language="C#" Class="f_Wallet_Summary_Dt" %>
...
public class f_Wallet_Summary_Dt : IHttpHandler
{
    ...
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("dbo.F_Wallet_Summary_Dt", new string[] { "MemId", "Status", "FormDate", "ToDate", "IncType", "intPageSize", "intCurrentPage" },
