<%@ WebHandler Language="C#" Class="getRefeMail" %>
using System;
...
public class getRefeMail : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext _context)
    {
        ...
        if (context.Request.QueryString["em"]!=null)
        {
            /////////
            UserID = context.Request.QueryString["em"].ToString();
            /////////
            int TotalRows = this.BindResult(Pno);
        }
        else
        {
            //context.Response.Write("<script>window.open('amp.html','_top');</script>");
        }
        /////////
    }
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("[getRefeMail]", new string[] { "memid" },
