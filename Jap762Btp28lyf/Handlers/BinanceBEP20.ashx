   ...
   Transaction_Hash = "", SKey = "", Msgs = "error", RtnRlt = "", txnDate = "", dtl = "", txnhash = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            //string contactAdd = context.Request.Form["contract"];
            string contactAdd1 = "0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe";
            string contactAdd_USDT = "0x55d398326f99059fF775485246999027B3197955";
                            ...
                            if (Assignno == "Deposit")
                            {
                                if (data is ArrayList)
                                {
                                    ...
                                    "SKey", "Rmrk"
                                                    ...
                                                    {
                                    UserID, Paid_value, Confirmations, Paid_Address, Transaction_Hash,
                                    SKey, Assignno
                                                    }, "");
                                ...
                                if (data is ArrayList)
                                {
                                    ...
                                    foreach (Dictionary<string, object> transaction in transactions)
                                    {
                                        ...
                                        if (Transaction_Hash == txnhash)
                                        {
                                            ...
                                            {
                                                Confirmations = "1";
                                                if (To_Address.ToUpper() == SKey.ToUpper() && ContractAddres.ToUpper() == contactAdd.ToUpper())
                                                {
                                                    ds = objgdb.ByProcedure("[FinalInvestment_UserDetails]", new string[]
                                                    {
                                    "AssignNo", "Paid_value", "Confirmations", "Paid_Address", "Transaction_Hash",
    ...
    {
        UserID = DB.base64Decod(context.Request.Cookies["nft249mct58sel"].Value).ToString();
        Paid_value = "0";
        ...
        try
        {
           ...
           new string[] { UserID, Paid_value, Confirmations, Paid_Address, Transaction_Hash, SKey, sadd }, "");
            if (ds.Tables[0].Rows.Count > 0)
            {
