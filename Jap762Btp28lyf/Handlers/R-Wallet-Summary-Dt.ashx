<%@ WebHandler Language="C#" Class="R_Wallet_Summary_Dt" %>
...
public class R_Wallet_Summary_Dt : IHttpHandler
{
    ...
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("dbo.R_Wallet_Summary_Dt", new string[] { "MemId", "Status", "FormDate", "ToDate", "IncType", "intPageSize", "intCurrentPage" },
