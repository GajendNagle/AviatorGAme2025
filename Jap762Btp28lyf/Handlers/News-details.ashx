<%@ WebHandler Language="C#" Class="News_details" %>
...
public class News_details : IHttpHandler {
...
public HttpContext context; public HttpRequest request; public HttpResponse response;
    ...
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("[Proc_UserNewsDetails]", new string[] { "MemId", "Status", "intPageSize", "intCurrentPage" },
