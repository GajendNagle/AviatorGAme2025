<%@ WebHandler Language="C#" Class="AddBalanceStatus_Bank" %>
...
public class AddBalanceStatus_Bank : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext _context)
   {
    ...
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("dbo.ADDBalance_status_Bank", new string[] { "MemId", "Status", "intPageSize", "intCurrentPage" },
