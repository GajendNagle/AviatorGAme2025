<%@ WebHandler Language="C#" Class="AddBalancestatus_Txnhash" %>
...
public class AddBalancestatus_Txnhash : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext _context)
    {
        ...
        if (context.Request.Cookies["Tap190Nvw92mst"] != null)
        {
            ...
            {
                Inc = request.QueryString["IncType"].ToString();
            }
            else
            {
                Inc = "ALL";
    ...
    private int BindResult(int currentPage)
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("dbo.ADDBalance_status_Txnhash_New",
      new string[] { "MemId", "Status", "FormDate", "ToDate", "IncType", "intPageSize", "intCurrentPage" },
      new string[] { UserID.ToString().Trim(), SrchTxt, FrmDt, ToDt, Inc, Psize, Pno.ToString() },
      "intTotalRecords", out TotalRows, "ByDataset");
            dt = ds.Tables[0];
            int count = TotalRows;
