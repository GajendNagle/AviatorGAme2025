<%@ WebHandler Language="C#" Class="Inner_Page_Summary" %>
using System;
...
public class Inner_Page_Summary : IHttpHandler {
    ...
    private void BindResult()
    {
        ...
        try
        {
            ds = objgdb.ByProcedure("dbo.Inst_DashBoardSummary_Inner", new string[] { "MemID" },
