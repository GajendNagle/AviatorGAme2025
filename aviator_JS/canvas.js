...
function setVariable(is_plan = '') {
    ...
    // widthDouble = boardWidth * 3.5;
    // xPoint = 0 - (boardWidth * 1.7);
    // yPoint = boardheight - (boardWidth * 1.7);
    ...
    if (canvasWidth < 992) {
        ...
        imgyposition = 45;
        imgxposition = 10;
        imgTag.src = "https://totalwin.live/assets/aviator/images/sprite2.png";
        settimeinterval = 40;
        ...
        imgyposition = 66;
        imgxposition = 15;
        imgTag.src = "https://totalwin.live/assets/aviator/images/sprite3.png";
        settimeinterval = 20;
